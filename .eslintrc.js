/* eslint-disable */
// XXX colin: convert to using our coding conventions
module.exports = {
  "env": {
    "commonjs": true,
    "es6": true,
  ...
  "rules": {
    ...
    // XXX colin: get this to work only on generators
    ...
    "filenames/match-regex": [2, "^([a-z0-9_]+(.[a-z]+)?|Jakefile)$", true],
    ...
    "padding-line-between-statements": ["error",
      {"blankLine": "always",
        ...
        "next": ["function", "multiline-const", "multiline-let"]},
      ...
      {"blankLine": "any", "prev": "multiline-const",
